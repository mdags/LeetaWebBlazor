...
namespace DataAccessLibrary
{
    ...
    {
        Task Delete(AddressModel model);
        Task<List<AddressModel>> GetList();
        Task<List<AddressModel>> GetList(string[] args1, object[] args2);
        Task Save(AddressModel model);
    }

    public class AddressData : IAddressData
    {
        private readonly ISqlDataAccess db;
        private const string tableName = "tbl_member_address";
        ...
        public Task<List<AddressModel>> GetList()
        {
            string sql = string.Format("select * from [{0}]", tableName);

            return db.LoadData<AddressModel, dynamic>(sql, new { });
        }

        public Task<List<AddressModel>> GetList(string[] args1, object[] args2)
        {
            ...
            return db.LoadData<AddressModel, dynamic>(sql, parameters);
        }

        public Task Save(AddressModel model)
        {
        ...
        public Task Delete(AddressModel model)
        {
